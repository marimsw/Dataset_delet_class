...
process_yolo_dataset(
    input_dir="D:\MS\Детекция\Бокс\Перчатки для бокса\RoboBox2.v8i.yolov8",
    output_dir="D:\MS\Детекция\Бокс\Перчатки для бокса\RoboBox2.v8i.yolov8\Dataset_one",
    target_classes=[0],  # ID классов, которые нужно оставить
    remove_classes=[1],  # ID классов, которые нужно удалить
